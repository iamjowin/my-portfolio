    ...
    <div>
        ...
        <div class="flex">
            <div class="w-1/2 max-w-sm p-6 bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">No Description...</p>
            ...
            <div class="pl-6 text-xs text-slate-500">2018 - 2019</div>
        </div>
        
        <div class="flex">
            <div class="w-1/2 max-w-sm p-6 bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700 mt-4">
                <a href="#">
                    <h5 class="mb-2 font-bold tracking-tight text-slate-700 dark:text-white">PROLOOK SPORTSsssss</h5>
                </a>
            ...
            <div class="pl-6 text-xs mt-4 text-slate-500 font-bold">2019 - 2023</div>
        </div>
    </div>
</template>
<script setup>
