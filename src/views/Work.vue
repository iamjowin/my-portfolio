    ...
    <div>
        ...
        <div class="flex">
            <div class="max-w-sm p-6 bg-white border">
                ...
                <p class="mb-3 font-normal text-gray-700">Analyzing data and providing feedback from consumers and employees and then proposing solutions in order to finalize the designs.</p>
