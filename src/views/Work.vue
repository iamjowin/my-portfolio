<template>
    <div>
        ...
        <div class="flex">
            <div class=" max-w-sm p-6 bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
        ...
        <div class="flex">
            <div class=" max-w-sm p-6 bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700 mt-4">
                <a href="#">
